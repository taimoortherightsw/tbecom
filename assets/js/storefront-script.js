let tbecomAppId = 'tbecom-custom-address',
	tbecomHost = 'https://taimoortherightsw.github.io/tbecom';

(function () {
	if (typeof jQuery == 'undefined') {
		let script = document.createElement('script');
		script.type = 'text/javascript';
		script.src = `${tbecomHost}/assets/js/jquery-3.6.0.min.js`;
...
$(function () {
	Ecwid.OnPageLoaded.add(function (page) {
		if (page.type == 'CHECKOUT_ADDRESS') {
			...
			let appConfig = JSON.parse(Ecwid.getAppPublicConfig(tbecomAppId));
